...
class ProductView extends GetView<ProductController> {
  ...
  Widget _productCard(ProductModel product) {
    final hasDiscount = product.discountedPrice > 0 && product.discountedPrice < product.price;
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(16.r), // Slightly tighter radius for a modern feel
          boxShadow: [
            BoxShadow(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        product.category.imageUrl, // Assuming this contains an emoji string
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    product.name,
                    maxLines: 1, // Tightened to 1 line for crisp catalog look, or keep 2 if needed
